...
export default function MissionControlPreviewVariantAKnowledgeReviewPage() {
  return (
    <PreviewWorkspaceFrame variant="a" eyebrow="System Workspace" title="Knowledge Review">
